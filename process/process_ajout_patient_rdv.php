...
if (
    ...
    if ($isSuccess) {
        header('Location: ../liste_patient.php?success=Le patient et son rdv ont bien été ajouté !');    
    } else {
        header('Location: ../ajout_patient.php?error=Erreur lors de l\'enregistrement du patient et du rdv !');    
    }
